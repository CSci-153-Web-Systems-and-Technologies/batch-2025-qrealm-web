  ...
  const features = [
    {
      ...
      description: "Guests scan QR codes for instant access to event galleries without needing accounts."
    },
    {
      icon: Upload,
      title: "Easy Photo Upload",
      description: "Simple, mobile-optimized interface for guests to upload photos directly from their phones."
    },
    {
      icon: Shield,
      title: "Content Moderation",
      description: "All uploads require host approval before appearing publicly, ensuring quality control."
    },
    {
      icon: Eye,
      title: "Real-time Galleries",
      description: "Photos appear in galleries immediately after approval for instant event memories."
    },
    {
      icon: Smartphone,
      title: "Mobile-First Design",
      description: "Optimized for mobile devices where most event photos are taken and shared."
    },
    {
      icon: Users,
      title: "Event Management",
      description: "Hosts can create, manage, and moderate multiple events from a central dashboard."
    }
  ]
  ...
  const steps = [
    {
      ...
      description: "Sign up and create a new event gallery with custom settings and moderation controls."
    },
    {
      number: "02",
      title: "Generate QR Code",
      description: "Get a unique QR code for your event that guests can scan for instant access."
    },
    {
      number: "03",
      title: "Share with Guests",
      description: "Display the QR code at your event or share it digitally with attendees."
    },
    {
      number: "04",
      title: "Collect & Moderate",
      description: "Guests upload photos, you approve them, and everyone enjoys the shared memories."
    }
  ];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/10">
        ...
        <div className="w-full !px-6 sm:px-8 lg:px-12 !py-20 lg:py-32 flex justify-center">
          ...
          <div className="text-center max-w-4xl ">
            ...
            <h1 className="text-4xl lg:text-6xl !mb-16 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent text-bold">
              Effortless Event Photo Sharing with QR Code Access
            </h1>

            <p className="text-xl text-muted-foreground !mb-12">
              Create event photo galleries that guests can access instantly by scanning QR codes.
              No apps to download, no accounts required for guests – just scan, upload, and share memories.
            </p>
        ...
        <div className="w-full !px-6 sm:px-8 lg:px-12 !py-20 lg:py-24 flex justify-center">
          <div className="text-center max-w-6xl w-full">
            <div className="text-center !mb-16">
              ...
              <p className="text-lg !px-12 text-muted-foreground max-w-6xl mx-auto">
                Professional-grade features designed specifically for schools, organizations, and event hosts
                who want seamless photo collection from their guests.
              </p>
            </div>
        ...
        <div className="w-full !px-6 sm:px-8 lg:px-12 !py-20 lg:py-24 flex justify-center">
          <div className="text-center max-w-6xl w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
              {steps.map((step) => (
                <div key={step.number} className="text-center max-w-xs justify-items-center">
                  <div className="w-20 h-20 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto !mb-6 text-xl font-bold">
                    {step.number}
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground !mb-8 leading-relaxed">
                  ...
                  institutions, nonprofits, and professional event
                  organizers who need reliable, secure photo
                  collection with proper moderation controls.
                </p>
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 !mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        All uploads require host approval before
                        going public
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 !mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Perfect for on-the-go photo uploads at
                        events
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl w-full">
            <div className="event-highlights">
              <div className="group-15">
                ...
                <div className="discover-the-best-moments !px-16 text-lg text-muted-foreground text-center !mb-16 leading-relaxed">
                  Discover the best moments from across all school events, automatically
                  curated from our photo collections to showcase the most memorable
                  experiences.
                </div>
              </div>
                    ...
                    <div className="w-[372px] p-3 rounded-[20px]">
                      <div className="w-full h-[328px] rounded-[33px] overflow-hidden relative shadow-2xl">
                        ...
                        <div className="absolute bottom-3 left-3 right-3 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-[22px] py-1 shadow-lg">
                          <p className="text-[#323031] !px-6 text-left text-sm">Dormitory Team building</p>
                          <p className="text-[#022c44] !px-6 text-left text-[10px]">Sport</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="w-[372px] p-3 rounded-[20px]">
                      <div className="w-full h-[328px] rounded-[33px] overflow-hidden relative shadow-2xl">
                        ...
                        {/* Text INSIDE image container */}
                        <div className="absolute bottom-3 left-3 right-3 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-[22px] py-1 shadow-lg">
                          <p className="text-[#062a40] !px-6 text-left text-sm">Annual Assembly</p>
                          <p className="text-[#022c44] !px-6 text-left text-[10px]">General</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="w-[372px] p-3 rounded-[20px]">
                      <div className="w-full h-[328px] rounded-[33px] overflow-hidden relative shadow-2xl">
                        ...
                        {/* Text INSIDE image container */}
                        <div className="absolute bottom-3 left-3 right-3 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-[22px] py-1 shadow-lg">
                          <p className="text-white !px-6 text-left text-sm">Annual Assembly</p>
                          <p className="text-[#858ded] !px-6 text-left text-[10px]">General</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="w-[372px] p-3 rounded-[20px]">
                      <div className="w-full h-[328px] rounded-[33px] overflow-hidden relative shadow-2xl">
                        ...
                        {/* Text INSIDE image container */}
                        <div className="absolute bottom-3 left-3 right-3 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-[22px] py-1 shadow-lg">
                          <p className="text-white !px-6 text-left text-sm">Graduation 2024</p>
                          <p className="text-[#8a8a8a] !px-6 text-left text-[10px]">Academic</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl w-full">
            ...
            <div className="text-center !mb-16">
              ...
              <p className="text-lg text-muted-foreground !px-8 leading-relaxed">
                Stay updated with upcoming events and relive the highlights from recent celebrations. 
                Each event has its own QR code for instant access.
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-6 py-2">
                        <p className="text-white text-center font-semibold">Graduation 2024</p>
                        <p className="text-[#8a8a8a] text-center text-sm">Academic</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <h3 className="text-2xl font-bold text-[#333333]">Graduation 2024</h3>
                      <p className="text-muted-foreground">
                        Celebrate the achievements of our graduating class with memorable photos 
                        from the ceremony and reception.
                      </p>
                ...
                <div className="flex-1">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 backdrop-blur-[5.1px] bg-white/10 border border-white/28 rounded-[20px] px-6 py-2">
                        <p className="text-[#062a40] text-center font-semibold">Annual Assembly</p>
                        <p className="text-[#022c44] text-center text-sm">General</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <h3 className="text-2xl font-bold text-[#333333]">Annual Assembly</h3>
                      <p className="text-muted-foreground">
                        Our yearly gathering featuring student performances, awards, 
        ...
        <div className="w-full !px-6 sm:px-8 lg:px-12 !py-20 lg:py-24 flex justify-center">
          <div className="text-center max-w-4xl w-full">
            ...
            <p className="text-lg opacity-90 !mb-12 w-full">
              Join schools and organizations already using our platform for seamless, professional event photo sharing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/dashboard">
